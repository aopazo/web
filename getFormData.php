<?php
	...
	if(isset($_POST['action'])) { $action = safe($_POST['action']); }
	if(isset($_POST['asunto'])) { $asunto = safe($_POST['asunto']); }
	if(isset($_POST['renovacion'])) { $renovacion = safe($_POST['renovacion']); }
