	...
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12">
			<ul class="list icons list-unstyled">
				...
				<li><i class="fa fa-user fa-fw"></i> <a href="login">Ingreso</a></li>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<ul class="list icons list-unstyled">
				<li><i class="fa fa-trophy fa-fw"></i> <a href="queganoyo">¿Qué gano yo?</a></li>
...
<div class="footer-copyright">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<p>© Atempus 2015. Todos los derechas reservados.</p>
			</div>
		</div>
	</div>
</div>
